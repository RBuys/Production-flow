...
Private Sub ProcessJCWorkbook(ByVal filePath As String, _
    ...
    For Each ws In wb.Worksheets
        ...
        ' J = 1, L = 3, P = 7
        data = ws.Range("J9:P38").Value

        For r = 1 To UBound(data, 1)

            materialText = Trim$(CStr(data(r, 1))) ' Column J
            If materialText = "" Then GoTo NextRow

            ' NEW filter: column L must have a value
            If Trim$(CStr(data(r, 3))) = "" Then GoTo NextRow

            ' Existing filter: column P must be blank
            If Trim$(CStr(data(r, 7))) <> "" Then GoTo NextRow
            ...
            targetSheet.Cells(writeRow, 2).Value = materialText
            writeRow = writeRow + 1
...
' ============================================================
' WORKSHOP PATH RESOLUTION (UNC / FILE SERVER SAFE)
' ============================================================
